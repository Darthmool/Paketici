...
%\par Kao Å¡to smo veÄ istakli, postojanje familija asteroida prvi je primetio japanski astronom Hirajama joÅ¡ daleke 1918. godine. TrudiÄemo se da ovde damo Å¡to je moguÄe potpuniji pregled svega Å¡to se tokom proteklog stoleÄa deÅ¡avalo na ovom polju.
...
%\item Älanovi familije ne predstavljaju dominantnu populaciju kod malih asteroida.
%\item u trenutku nastanka familije njeni Älanovi nisu izbaÄeni velikim brzinama.
%\item familije su znaÄajno evoluirale u odnosu naÂ post-sudarnuÂ situaciju.
%\item inicijalno polje brzina teÅ¡ko da moÅ¾e biti rekonstruisano.
%\item starost familija se moÅ¾e odrediti.
%\item Älanovi familija su veÄinomÂ re-akumulirani.
